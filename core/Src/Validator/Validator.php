...
class Validator
{
   ...
   private function validateField(string $fieldName, array $fieldValidators): void
   {
      ...
      foreach ($fieldValidators as $validatorName) {
          ...
          $validatorClass = $this->validators[$validatorName] ?? null; // Добавляем проверку на существование ключа
          ...
          $validator = new $validatorClass(
              ...
              $args,
              $this->messages[$validatorName] ?? null // Добавляем проверку на существование ключа
          );
